        ...
        <link rel="stylesheet" href="{{asset('css/estilos-RECIP/perfil/perfil.css')}}"> 
        <div class="container-perfil">
            <!-- contenido principal de perfil columna central -->
            <div class="main-container">
                <!-- portada perfil -->
                <div class="profile">
                        <div class="profile-avatar">
                            <img src="https://i0.wp.com/qepd.news/wp-content/uploads/2020/05/matias-laca.jpg?fit=800%2C533&ssl=1" alt="" class="profile-img">
                            <div class="profile-name">Matia Laca</div>
                        </div>
                        <img src="https://i.mycdn.me/image?id=920796780807&t=50&plc=WEB&tkn=*sOTP6JnxUfGi6FQF2jZ3ovAt7UU&fn=external_8" alt="" class="profile-cover">
                        <div class="profile-menu">
                            <a class="profile-menu-link active">Linea de tiempo</a>
                            <a class="profile-menu-link">Acerca de</a>
                            <a class="profile-menu-link">Amigos</a>
                            <a class="profile-menu-link">Fotos</a>
                            <a class="profile-menu-link">Más</a>
                        </div>
                </div>
                <div class="timeline">
                        <div class="timeline-left">
                                <!-- introduccion de usuario -->
                                <div class="intro box">
                                    <h2 class="intro-title">Introduction<button class="intro-menu"></button></h2>
                                    <div class="info">
                                        <div class="info-item">
                                        ...
                                        creador digital <a href="#">Hombres Alfa</a>
                                        </div>
                                        <div class="info-item">
                                        ...
                                        Vive en <a href="#">Mexico, Monterrey</a>
                                        </div>
                                        <div class="info-item">
                                ...
                                <div class="event box">
                                    <div class="event-wrapper">
                                        ...
                                        <div class="event-date">
                                            <div class="event-month">Enero</div>
                                            <div class="event-day">01</div>
                                        </div>
                                        <div class="event-title">conferencia en guadalajara</div>
                                        <div class="event-subtitle">01st Jan, 2019 07:00AM</div>
                                    </div>
                                </div>
                                <!-- paginas seguidad o seguidos -->
                                <div class="pages box">
                                    <h3 class="intro-title">Your pages<button class="intro-menu"></button></h3>
                                    <div class="user">
                        ...
                        <div class="timeline-right">
                                ...
                                <div class="status box">
                                    <div class="status-menu">
                                        <a class="status-menu-item active" href="#">Estado</a>
                                        <a class="status-menu-item" href="#">Fotos</a>
                                        <a class="status-menu-item" href="#">Videos</a>
                                    </div>
                                    <div class="status-main">
                                        <img src="https://i0.wp.com/qepd.news/wp-content/uploads/2020/05/matias-laca.jpg?fit=800%2C533&ssl=1" class="status-img">
                                        <textarea class="status-textarea" placeholder="escribe algo Matias Laca.."></textarea>
                                    </div>
                                ...
                                <div class="album box">
                                    ...
                                    <div class="album-title"><strong>Matias laca</strong> crear nuevo<span> album</span></div>
                                    <div class="album-date">6 hours ago</div>
                                    </div>
                                    <button class="intro-menu"></button>
                                    </div>
                                    <div class="album-content">Cuando el bajo cae, también lo hacen mis problemas.
                        ...
                        <!-- COlumna derecha (cuenta,historia,contacto,mini-buscador) -->
                        <div class="right-side" >
                        <!-- HISTORIAS -->
                            <div class="side-wrapper stories">
                                <div class="nav__titulo">HISTORIAS</div>
                                <div class="user">
                                ...
                                <div class="user">
                                <img src="https://images.pexels.com/photos/598745/pexels-photo-598745.jpeg?h=350&auto=compress&cs=tinysrgb" alt="" class="user-img">
                        ...
                        <!-- CONTACTOS -->
                            <div class="side-wrapper contacts">
                                <div class="nav__titulo">CONTACTOS</div>
                                <div class="user">
